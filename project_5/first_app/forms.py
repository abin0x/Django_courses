...
class contactForm(forms.Form):
    name=forms.CharField(label="Full Name : ",initial="Abin",help_text="Total text must be with in 50 characters",required=False,widget=forms.Textarea(attrs={'id':'text_area','class':'class1 class2','placeholder':'Enter your name'}))
    ...
    MEAL=[('P','Pizza'),('M','Mashroom'),('B','Beaf')]
